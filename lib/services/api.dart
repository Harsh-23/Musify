...
Future<List> getTopSongs() async {
  final Response resp = await dio.get("/api.php?__call=webapi.get&token=8MT-LQlP35c_&type=playlist&p=1&n=20&includeMetaTags=0&ctx=web6dot0&api_version=4&_format=json&_marker=0");
...
Future<List> searchSong(String query) async {
  String searchUrl = "/api.php?__call=autocomplete.get&query=hello&_format=json&_marker=0&ctx=web6dot0";
